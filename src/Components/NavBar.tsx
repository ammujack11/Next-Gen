...
function NavBar() {
    return(
        <nav className="fixed top-0 left-0 z-50 flex h-16 w-full justify-between bg-black items-center text-white px-2 md:px-10">
            ...
            <div className="flex text-[14px] md:text-lg space-x-2 md:space-x-8">
